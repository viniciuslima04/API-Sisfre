...
<?php $__env->startSection('titulo','Anteposições do Curso'); ?>
                ...
                <div class="row col-md-12 col-md-offset-0">
                    ...
                    <?php if($anteposicoes->count() == 0 && empty($pesquisa) && empty($filtro) ): ?>
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 danger text-center">
                            Não há anteposições registradas para o curso: <br><b> <?php echo e(auth()->user()->professor->curso->nome); ?></b>.
                        </div>
                    ...
                    <?php elseif($anteposicoes->count() == 0 && !empty($pesquisa) && !empty($filtro) ): ?>
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            Nenhuma anteposição foi encontrada para o/a professor(a):<br> <b class="text-uppercase"> <?php echo e($pesquisa); ?></b>
                            utilizando o filtro: 
                            <b>
                                <?php if($filtro == "ESP"): ?>
                        ...
                        <div class="row col-md-2 col-md-offset-0">
                            <div class="form-group text-center text-uppercase">
                                <a href="<?php echo e(route('anteposicao.show.coordenador')); ?>" class="btn btn-block btn-lg btn-primary">
                    ...
                    <?php elseif($anteposicoes->count() == 0 && !empty($pesquisa) && empty($filtro)): ?>
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            Nenhuma anteposição foi encontrada para o/a professor(a): <br><b class="text-uppercase"> <?php echo e($pesquisa); ?></b> neste curso.
                        </div>
                    ...
                    <div class="row col-md-12 col-md-offset-0">
                          <form method="GET" action="<?php echo e(route('anteposicao.show.coordenador')); ?>">
                        ...
                        <table class="table table-striped bunitu">
                            ...
                            <?php $__currentLoopData = $anteposicoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anteposicao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="row text-uppercase">
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <div class="btn-group-xs btn-group-vertical btn-block">
                                            <?php if($anteposicao->situacao == 'ESP' || $anteposicao->situacao == 'NEG'): ?>
                                                <a class="btn btn-success" data-toggle="modal" data-target="#modal_confirmar_remover" data-entidade="anteposicao" data-url="<?php echo e(route('anteposicao.confirmar',$anteposicao->id)); ?>" data-modo="confirmar"> 
                                                    <span class="glyphicon glyphicon-ok"></span> Confirmar
                                                </a>

                                                <a class="btn"></a>
                                            <?php endif; ?>
                                            <?php if($anteposicao->situacao != 'NEG'): ?>
                                                <a class="btn btn-danger" data-toggle="modal" data-target="#modal_confirmar_remover" data-entidade="anteposicao" data-url="<?php echo e(route('anteposicao.cancelar',$anteposicao->id)); ?>" data-modo="remover">
