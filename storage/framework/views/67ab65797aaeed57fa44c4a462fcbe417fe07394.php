<?php $__env->startSection('titulo','Minhas Faltas'); ?>
            ...
            <div class="panel-body">
                <div class="row col-md-12 col-md-offset-0">
                        ...
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            ...
                            <b class="text-uppercase">
                                ...
                                <?php elseif($situacao == "PAGA_T"): ?>
                                    Totalmente reposta
                                <?php endif; ?> 
                            </b> foi encontrada para a disciplina: <br><b class="text-uppercase"> <?php echo e($pesquisa); ?> </b> no semestre dado.
                        </div>

                        <div class="row col-md-2 col-md-offset-0">
                            <div class="form-group text-center text-uppercase">
                                <a href="<?php echo e(route('falta.show.professor')); ?>" class="btn btn-block btn-lg btn-primary">
                    ...
                    <?php elseif($faltasVerificadas->count() == 0 && !empty($pesquisa) && empty($semestre) && empty($situacao) ): ?>
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            Nenhuma falta foi encontrada para a disciplina: <br> <b class="text-uppercase"> <?php echo e($pesquisa); ?></b> no sistema.
                        </div>
                    ...
                    <?php elseif($faltasVerificadas->count() == 0 && !empty($pesquisa) && !empty($semestre) && empty($situacao)): ?>
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            Nenhuma falta foi encontrada para a disciplina: <br> <b class="text-uppercase"> <?php echo e($pesquisa); ?></b> no semestre dado.
                        </div>
                        ...
                        <div class="alert alert-info btn-lg col-md-8 col-md-offset-2 text-center">
                            ...
                            <b class="text-uppercase">
                                ...
                                <?php elseif($situacao == "PAGA_T"): ?>
                                    Totalmente reposta
                                <?php endif; ?> 
                            </b> foi encontrada para a disciplina: <br> <b class="text-uppercase"> <?php echo e($pesquisa); ?> </b> no sistema.
                        </div>
                    ...
                    <div id="container-pesquisar" class="row col-md-10 col-md-offset-1">
                          <form method="GET" action="<?php echo e(route('falta.show.professor')); ?>">
                                ...
                                <tr class="row text-uppercase">
                                    ...
                                    <td  class="text-center" style="vertical-align: middle;">
                                        <div class="btn-group-xs btn-group-vertical btn-block">
                                            <?php if($falta->situacao == 'CONF'): ?>
                                                <?php if($falta->reposicoes->where('situacao','=','ESP')->where('qtd','<',$falta->qtd)->count() <= 1 && $falta->reposicoes->where('situacao','=','ESP')->where('qtd','=',$falta->qtd)->count() == 0): ?>
                                                    <a class='btn btn-info' href="<?php echo e(route('reposicao.create',['professor',$falta->id])); ?>">
                                                        <span class="glyphicon glyphicon-plus"></span> Reposição
                                                    </a>
                                                    <a class="btn"></a>
                                                <?php endif; ?>
                                            <?php elseif($falta->situacao == 'PAGA_P'): ?>
                                                <?php if($falta->reposicoes->where('situacao','=','ESP')->count() == 0): ?>
                                                    <a class='btn btn-info' href="<?php echo e(route('reposicao.create',['professor',$falta->id])); ?>">
                                                        <span class="glyphicon glyphicon-plus"></span> Reposição
                                                    </a>
                                                    <a class="btn"></a>
