                            ...
                            <td class="text-center form-group">
                                <select class="selectpicker form-control select-center" id="horario{{$aula}}{{$dia}}" name="horario[{{$aula}}][{{$dia}}]">
                                    ...
                                    @foreach($disciplinas as $disc)
                                        @if(old('horario.{{$aula}}.{{$dia}}') == $disc->id)
        ...
        @foreach($disciplinas as $disc)
           <div class="row col-md-12">
                <div class="form-group col-md-6 disciplina{{$disc->id}}">
                    <div class="col-md-12">
                        <input id="disciplina{{$loop->iteration}}" name="disciplina[{{$disc->id}}]" maxlength="160" data-nome="{{$disc->nome}}" data-ch="{{$disc->aula_semanal}}" value="{{$disc->sigla}} - {{$disc->nome}}" data-id="{{$disc->id}}" class="form-control input-md" type="text" readonly>
