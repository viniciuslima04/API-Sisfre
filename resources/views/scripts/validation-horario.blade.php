    ...
    function verifica_professor(){
      ...
      for (var i = 1; i <= qtd_disciplinas; i++) {
        ...
        if(professor_id == 0){
          ...
          if(verifica_qtd_professor(professor_id, qtd_disciplinas) > 4){
            $(".professor"+disciplina_id).addClass('has-error');
            $('#professor'+disciplina_id+disciplina_id).text('O professor selecionado não pode ter mais de 4 disciplinas associadas');
            erros++; 
          }
          else{
